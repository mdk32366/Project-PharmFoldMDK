  ...
  return (
    <div className="scorer">
      ...
      <section className="scorer-labels">
        <h3>B · The labels</h3>
        <p>
          <b>{r.n_fit_positives}</b> curated Group B accessions, against the paper's{' '}
          <b>{r.paper_published_count}</b> published — the gap is a finding, its explanations named
          and unresolved (F-003).
        </p>
        <p>
        ...
        <p className="exclusion-classes">
          ...
          and family-member ADCs (F-003 Finding 4).
        </p>
      </section>
      ...
      <section className="scorer-result">
        ...
        <div className="caveats">
          ...
          <p><b>(b)</b> An open confound: <Term name="pLDDT">pLDDT</Term> may carry attention.{' '}
            <Term name="pLDDT">pLDDT</Term> is partly a function of how well-represented a family is in{' '}
            <Term name="ESMFold">ESMFold</Term>'s training data, which tracks research attention. The
            near-zero Spearman argues against it, but the comparator is a weak stand-in. Open, not
            resolved (tested by D-065).</p>
      ...
      <section className="scorer-table">
        ...
        <table className="ranking-table">
          <thead><tr><th>Rank</th><th>Symbol</th><th>Structural score</th></tr></thead>
          <tbody>

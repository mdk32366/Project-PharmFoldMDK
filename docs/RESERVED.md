...
| **D-145** | *Nothing yet* — the next free `D-` integer, barred by name in the seven next-free guards. | `D-144`, 2026-09-09 | **The next entry.** ⚠ Listed here only because `D-144` cites it in order to bar it; a bare `### D-145` reddens seven tests until an entry claims it by name. |

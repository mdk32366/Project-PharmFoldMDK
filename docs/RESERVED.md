...
reserved-unwritten below. **`F-033`** (selenocysteine absent from the ESM vocabulary) **was written on 2026-08-16.** **`F-034`** (a verification harness that would have exceeded the fold ceiling) **was written on 2026-08-16.** ⚠ **Next free `F-` integer: `F-035`.**

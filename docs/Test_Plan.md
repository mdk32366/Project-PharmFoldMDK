...
### D-142 (this PR; T-1225–T-1232) — the field that looked like the description was the gene symbol

Acceptance tests in `tests/test_d142_targets_columns.py` (47),
`ui/src/components/TargetList.columns.test.jsx` (32) and
...
requires `### D-142` to be the target-list columns entry by name and bars `### D-143`.

...
## Addendum 2026-09-09 — D-143 the `/targets` Cancer association + Description columns

### D-143 (this PR; T-1235–T-1242) — the field that looked like the description was the gene symbol

Acceptance tests in `tests/test_d143_targets_columns.py` (47),
...
that raises if a read path ever reaches it. Cite `### D-143`, the **Matt GO 2026-09-08

...
> **D-127-A** ships the core BUILD (this PR): sibling
...
> D-127-B later (UI + **mandatory** Method). D-125 Kabsch +
...
> later names that fourth path (and Method). Production triple-path
> is unchanged.
...
2. **Every design decision is written into [`docs/README.md`](docs/README.md) *before*
   ...
   ships the core sibling path (this PR; D-125 Kabsch + D-126
   confidence + assembler remain callable; Method / four-path UI
   remain D-127-B); D-121 ships the Method hold-48 8th-grade

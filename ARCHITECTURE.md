...
> allowed. **D-126-A** is the core BUILD: sibling
> `core/hold48_confidence_kabsch.py` + `confidence_kabsch/{parent}/`
> tree; does not edit `hold48_kabsch.py`. D-125 Kabsch + assembler
...
> D-126-B UI is later. Production dual-path is unchanged.
...
2. **Every design decision is written into [`docs/README.md`](docs/README.md) *before*
   ...
   ships the core sibling path (D-125 Kabsch + assembler remain
   callable); D-121 ships the Method hold-48 8th-grade

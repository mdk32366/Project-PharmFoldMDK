...
> stay callable. **D-128 ships** the linker / seam honesty Spec (**this
> PR**, docs only;
...
> D-127 failed experiment stays disclosed.** **D-128-A** (core) and
> **D-128-B** (UI + mandatory Method) are later Emma GOs; this Spec PR
> edits no `hold48_*.py`, no UI, and no Method. D-124 A+B is on

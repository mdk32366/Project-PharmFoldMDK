...
> piecewise / domain-aware Kabsch Spec (this PR, docs only;
> [`docs/SPEC-piecewise-domain-kabsch.md`](docs/SPEC-piecewise-domain-kabsch.md));
> 10.0 Å gate stays; no trim loop; D-127-A/B later. D-125 Kabsch +
...
> is unchanged. D-127 names a later fourth sibling path
> (`piecewise_kabsch/`); this PR does not implement it.
...
2. **Every design decision is written into [`docs/README.md`](docs/README.md) *before*
   ...
   ships the piecewise / domain-aware Kabsch Spec (docs only; A/B
   later); D-121 ships the Method hold-48 8th-grade

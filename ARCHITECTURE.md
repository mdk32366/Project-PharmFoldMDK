...
object computed from `core/manifest.py` over **all 82**, joined to `protein_analyses` for
`fold_status`, i.e. the honest denominator the fold-derived list structurally cannot give.

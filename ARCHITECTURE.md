...
> **D-127-B ships** UI four-path honesty **and** the Spec §7
> **mandatory** Method addendum (this PR): `app/piecewise_kabsch_path_read.py`
...
> owner markdown + `/method` gain the D-127-B addendum. B reads A's

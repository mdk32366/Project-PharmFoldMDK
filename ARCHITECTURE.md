...
> D-127 failed experiment stays disclosed.** **D-128-A** already ships
> that core BUILD (**this PR**): sibling `core/hold48_linker_seam.py` +
...
> surface may say seams are solved. D-124 A+B is on
...
2. **Every design decision is written into [`docs/README.md`](docs/README.md) *before*
   ...
   ships UI four-path honesty and the mandatory Spec §7 Method
   addendum (this PR); D-121 ships the Method hold-48 8th-grade

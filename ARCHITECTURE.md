...
> Phase 1 P0 honesty; parent PLAN is **D-117**.
...
2. **Every design decision is written into [`docs/README.md`](docs/README.md) *before*
   ...
   [`docs/decisions.md`](docs/decisions.md) indexes which id **ships** (D-119 ships
   ADC-A; D-118 ships P0 honesty; D-117 is the parent PLAN). Do not rename
   D-118 or D-119 mid-flight.

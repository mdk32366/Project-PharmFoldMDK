...
# ⚠ `test_restore_refuses_even_for_the_owner` MOVED to `tests/test_f078_restore_refused.py`
# (`ORDERS` §1.3): this file is deleted when the debt is paid, and the refusal guard must outlive it.

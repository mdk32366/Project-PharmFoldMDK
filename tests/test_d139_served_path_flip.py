...
def test_d139_entry_exists_in_the_living_log():
    ...
    # permanence, and **no served path, no gate and no threshold moves**, which is the only
    # thing this suite is about. `### D-146` now takes the next-free bar.
    ...
    # and **no served path, no gate and no threshold moves**, which is the only thing this suite
    # is about. `### D-147` now takes the next-free bar.

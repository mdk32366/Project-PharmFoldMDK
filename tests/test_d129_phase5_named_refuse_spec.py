...
def test_d129_is_the_next_free_decision_id():
    ...
    # 158–163 for the 2026-09-15 incident-closeout wave, and `### D-168` now takes the bar.
    # **148 stays absent** — the trafficking hold is unchanged.
        ...
        # ⚠ 166 is ADDED by the enqueue-idempotency constraint (`D-166`) — by enumeration,
        ...
        173,
        # ⚠ 174 is ADDED by ADC sibling / closed BLA footnotes (`D-174`) — by enumeration,
        # and never by a `>=`. Spending 174 reddened the previous form BY DESIGN.
        174
    ], (
        ...
        f"enumeration and never by a `>=`; `### D-168` now takes the bar. ⚠ The list itself is "

...
OWED_RESTORE = [
    ...
    "  They are slice 2 folds lost from BOTH stores at the 2026-09-13 cut - no artifact, no",
    "  database record - and they are still owed a re-fold.",
    "",
    ...
    "  claimed 64 ms later and did NOT. The hourly backup labelled 15:24:33Z corroborates",
    "  it and is not what the claim rests on.",
    "",
    ...
    "",
    "  !! ORDERING, AND IT IS SPECIFIC TO SLICE 4: restoring the 37 to tier 'local' while",
    "  slice 4's 600 are pending makes BOTH populations claimable at once, which contaminates",
    "  the per-band transport term this campaign exists to measure. Fold the 37 as their own",
    "  bounded population FIRST, or leave them NULL until slice 4 finishes. Either is fine.",

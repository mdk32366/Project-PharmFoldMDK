...
| `data/adcs/` | ADC-A v1 FDA-approved catalog (`adcs.v1.json`, D-119). ADC-B pages (`/adcs`, D-122) consume it via `GET /api/adcs`. Weekly Drugs@FDA watch is Emma's ops lane — see that folder's README. |
